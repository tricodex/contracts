...
contract NFTSpecialistAgent {
    ...
    constructor(address initialOracleAddress) {
        ...
        prompt = "You are an NFT Specialist, an expert in non-fungible tokens, digital art, and blockchain-based collectibles. Provide insights on NFT projects, market trends, and evaluation of NFT ideas.";
        _initializeConfig();
    }
