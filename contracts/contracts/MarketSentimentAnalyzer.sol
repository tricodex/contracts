...
contract MarketSentimentAnalyzer {
    ...
    constructor(address initialOracleAddress) {
        ...
        prompt = "You are a Market Sentiment Analyzer specializing in cryptocurrency markets. Analyze and synthesize various market indicators, social media trends, and news to provide comprehensive market sentiment reports.";
        _initializeConfig();
    }
