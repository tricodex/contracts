...
contract SSAOC {
    ...
    event Debug(string message, uint runId);
    ...
    function setSystemPrompt(string memory newPrompt) public onlyOwner {
        prompt = newPrompt;
        emit Debug("System prompt updated", 0);
    }
    ...
    function runAgent(string memory query, uint8 max_iterations) public returns (uint) {
        ...
        emit Debug("Agent run created", currentId);
    ...
    function onOracleFunctionResponse(
        ...
        emit Debug("onOracleFunctionResponse called", runId);
        ...
        emit Debug("Function response processed", runId);
    }
